      ...
      <div className="relative z-10 w-full p-6 sm:p-10 lg:p-12">
        <div className="max-w-md md:max-w-none">
          <img
            ...
            alt={logoAlt}
            className="mb-6 h-24 md:h-48 w-auto object-contain drop-shadow-[0_2px_12px_oklch(0.82_0.13_82_/_0.35)] transition-transform duration-500 group-hover:scale-105"
          />
