      ...
      <div className="relative z-10 w-full p-8 sm:p-12 lg:p-16">
        <div className="max-w-md">
          <img
            ...
            alt={logoAlt}
            className="mb-6 h-48 w-auto object-contain drop-shadow-[0_2px_12px_oklch(0.82_0.13_82_/_0.35)] transition-transform duration-500 group-hover:scale-105 sm:h-20 sm:w-20"
          />
